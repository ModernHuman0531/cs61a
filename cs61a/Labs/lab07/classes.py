...
class Player:
    ...
    def play(self, card_index):
        ...
        """
        "*** YOUR CODE HERE ***"
        card1 = self.hand[card_index]
        self.hand.remove(card1) #Remove method require the value instead of the index of the list
        return card1
...
class TutorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        """
        "*** YOUR CODE HERE ***"
        for i in range(3):#Remove the first three cards in the hand
            card_to_remove = opponent.hand[0]
            opponent.hand.remove(card_to_remove)
...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        "*** YOUR CODE HERE ***"
        #Add the opponent card's attack and defense to all cards in the player's deck
        ...
        #Remove all cards in the opponent's deck that have same attack or defense as the opponent's card
        opponent_deck = []
        for i in range(len(opponent.deck.cards)):
            if opponent.deck.cards[i].attack != other_card.attack and opponent.deck.cards[i].defense != other_card.defense:
                opponent_deck.append(opponent.deck.cards[i])
        opponent.deck.cards = opponent_deck
